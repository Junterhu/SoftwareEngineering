...
//		MoveCostCalculator mCC = new MoveCostCalculator();
//		for (int i = 0; i < householdItmes.size(); i++) {
//			System.out.println("Total Cost for " + householdItmes.get(i).getPrintable() + " is: "
//					+ mCC.calculate(householdItmes.get(i)) + " Euros");
//		}
//        System.out.println();
//        System.out.println();
//        
        PackageInstructor pI = new PackageInstructor();
        for(int i = 0; i < householdItmes.size(); i++) {
        	System.out.println(householdItmes.get(i).getPrintable());
        	System.out.println(" >" + pI.getInstructions(householdItmes.get(i)));
        }
	}
}
